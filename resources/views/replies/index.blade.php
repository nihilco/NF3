...
<div class="col-4">
<a href="{{ url('/replies/create') }}" class="btn btn-widget btn-primary"><i class="fas fa-plus"></i></a>
</div>
</div>
...
<div class="col">
		...
		<div class="card-header">
		  <h5 class="card-title mb-0">Replies List</h5>
		</div>
		<div class="card-body">
		...
		@forelse($replies as $reply)
		      ...
		      <tr>
		        ...
		        <td>{{ $reply->owner->email }}</td>
		        <td>{{ $reply->resource }}</td>
		        <td class="td-action">
		...
		@empty
		      ...
		      <tr>
		        <td colspan="4">No replies at this time.</td>
		      </tr>
