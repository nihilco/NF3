...
<div class="row">
<div class="col-8">
<h6>{{ $organizations->count() }}</h6>
<small>Organizations</small>
</div>
<div class="col-4">
<a href="{{ url('/organizations/create') }}" class="btn btn-widget btn-primary"><i class="fas fa-plus"></i></a>
</div>
</div>
...
<div class="col">
		...
		<div class="card-header">
		  <h5 class="card-title mb-0">Organizations List</h5>
		</div>
		<div class="card-body">
