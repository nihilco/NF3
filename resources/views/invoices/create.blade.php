...
@section('content')
		...
		<div class="card-body">
		    ...
		    <div class="form-group">
                      ...
                      <input type="text" class="form-control{{ $errors->first('ipv4') ? ' is-invalid' : '' }}" id="ipv4" name="ipv4" value="{{ old('ipv4') }}" />
		    ...
		    <div class="form-group">
                      ...
                      <input type="text" class="form-control{{ $errors->first('ipv6') ? ' is-invalid' : '' }}" id="ipv6" name="ipv6" value="{{ old('ipv6') }}" />
