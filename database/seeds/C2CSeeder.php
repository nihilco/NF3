...
class C2CSeeder extends Seeder
{
    /**
    ...
    'organization' => 'Oglethorpe University'
  ],
    [
    'first' => 'Morgan',
    'last' => 'Carter',
    ...
    'organization' => 'Karlsruhe Institute of Technology - Carl Benz School of Engineering'
  ],
    [
    'first' => 'Annette',
    'last' => 'Gambach',
    ...
    'organization' => 'United States Coast Guard Academy'
  ],
    [
    'first' => 'Patrick',
    'last' => 'Walsh',
    ...
    'organization' => 'Sewanee: The University of the South'
  ],
    [
    'first' => 'Castwell',
    'last' => 'Fider',
    ...
    'organization' => 'College of Coastal Georgia'
  ],
    [
    'first' => 'Betsy',
    'last' => 'Cotten',
    ...
    'organization' => 'Dalton State College'
  ],
    [
    'first' => 'Jamie',
    'last' => 'Ensley',
    'email' => 'jensley@edsouth.org',
    'organization' => 'Educational Funding of the South'
  ],
    [
    'first' => 'Katie',
    'last' => 'Morgan',
    ...
    'organization' => 'Xavier University School of Medicine'
  ],
    [
    'first' => 'Mallory',
    'last' => 'Reed',
    ...
    'organization' => 'Memphis College of Art'
  ],
    [
    'first' => 'Sandra',
    'last' => 'Labrecque',
    ...
    'organization' => 'Carson-Newman University'
  ],
    [
    'first' => 'Xan',
    'last' => 'Roseberry',
    ...
    'organization' => 'North Carolina Outward Bound School'
  ],
    [
    'first' => 'Stacy',
    'last' => 'Hall',
    ...
    'organization' => 'Les Roches - Switzerland'
  ],
    [
    'first' => 'Maggie',
    'last' => 'Brown',
    ...
    'organization' => 'Tennessee Wesleyan College'
  ],
    [
    'first' => 'John',
    'last' => 'Ferguson',
    ...
    'organization' => 'University of North Alabama-College of Arts and Sciences'
  ],
    [
    'first' => 'Andrew',
    'last' => 'Kupec',
    ...
    'organization' => 'Christian Brothers University'
  ],
    [
    'first' => 'Jacqueline',
    'last' => 'Hoefler',
    ...
    'organization' => 'The Art Institute of Tennessee-Nashville'
  ],
    [
    'first' => 'Demond',
    'last' => 'Lester',
    ...
    'organization' => 'Rust College'
  ],
    [
    'first' => 'Christian',
    'last' => 'Smith',
    'email' => 'christian.smith@montreat.edu',
    'organization' => 'Montreat College'
  ],
    [
    'first' => 'Nikayla',
    'last' => 'Loy',
    ...
    'organization' => 'Johnson & Wales University',
  ],
    [
    'first' => 'Evin',
    'last' => 'Dubois',
  ...
  if(app()->environment() == 'production' || app()->environment() == 'prod') {
	...
	//
	    ...
	    if(array_key_exists("middle", $rep)) {
	        $na['middle'] = $rep['middle'];
	    }

	    if(array_key_exists("suffix",$rep)) {
	        $na['suffix'] = $rep['suffix'];
	    }

	    if(array_key_exists("nickname",$rep)) {
	        $na['nickname'] = $rep['nickname'];
	    }

	    $name = factory(App\Models\Name::class)->create($na);
...
[
  'email' => 'collegefairs@neu.edu',
  'year' => '2016',
],
[
  'email' => 'collegefairs@northeastern.edu',
  'year' => '2017',
],
[
  'email' => 'collegefairs@northeastern.edu',
...
[
  'email' => 'urrecruitmenttravel@richmond.edu',
  'year' => '2016',
],
[
  'email' => 'urrecruitmentravel@richmond.edu',
  'year' => '2017',
],
[
  'email' => 'urrecruitmenttravel@richmond.edu',
...
[
  'email' => 'McLaughlin@southalabama.edu',
  'year' => '2018',
],
[
  'email' => 'brad.carlyle@chattanoogastate.edu',
